...
import {
  deleteExpenseSchema,
  fetchAllExpenseSchema,
  registerExpenseSchema,
} from '@routes/expense/schema';

export class ExpenseController {
  public constructor(private readonly _service: Service) {}

  //register
  public registerExpense: any = async (
    req: Request,
    res: Response
  ): Promise<void> => {
    ...
    try {
      if (req.body || req.params) {
        ...
        if (!result.error) {
          ...
          let registeredExpense = await this._service.registerExpense(
            newExpense
          );
  ...
  //fetch all Expense
  public getAllExpense: any = async (
    req: Request,
    res: Response
  ): Promise<void> => {
    // requestInterceptor(req);
  ...
  //Delete Expense
  public deleteExpense: any = async (
    req: Request,
    res: Response
  ): Promise<void> => {
    // requestInterceptor(req);
